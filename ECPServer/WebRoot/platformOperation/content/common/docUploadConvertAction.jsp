...
<%  
   ...
   // String saveDirectory =application.getRealPath("/")+"upload";  
  	String saveDirectory="D:/ECPServerUpload/OrgFile";
    //打印上传路径信息  
	...
	//	      String str="D:/ECPServerUpload/OrgFile/角色管理已审核信息查看接口.docx";
		      DocConverter d = new DocConverter(converfilename);
	//	      d.setOutputPath("D:/ECPServerUpload/OrgFile");  
		      //调用convert方法开始转换，先执行doc2pdf()将office文件转换为pdf;再执行pdf2swf()将pdf转换为swf;  
		      d.convert();  
		      //调用getswfPath()方法，打印转换后的swf文件路径  
		      System.out.println(d.getswfPath());  
		      String []strs=d.getswfPath().split("/");
		      //生成swf相对路径，以便传递给flexpaper播放器  
		      //String swfpath = d.getswfPath();
		      
		      String swfpath = "ECPServer/download?name="+strs[strs.length-1]+"^OrgFile";
		     // String swfpath=new String(swfpath1.getBytes("utf-8"),"iso-8859-1");
