...
/*	var userId*/
	var req = {};
	req["op"] = "getRoleInfoAuditedDetail";
...
function resGetRoleInfoAuditDetail(){
	...
	$("#audit_user_name").text(result.audit_user_name);
...
function resAuditRoleInfo(){
	var retData =cVe.XHR.responseText;
	var retDataObj=JSON.parse(retData);s
...
function goBack(){
	window.location.href="roleInfoAuditedList.jsp";
};
