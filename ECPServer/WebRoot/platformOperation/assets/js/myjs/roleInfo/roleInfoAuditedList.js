...
function roleInfoAuditList(){
	grid= $('#roleInfoAuditListTable').jqGrid({ 
		  ...
		  datatype:'local',  
		  //altRows: true,
		  colNames:['角色类型','申请者姓名','审核时间','审核人','审核结果',''],
		  shrinkToFit:false,
		  height:400,
		  rowNum:10,
	      rowList: [10, 20, 30],
...
function displayButtons(cellValue,options,rowObject){
	...
	var audit = '<button class=" btn btn-primary btn-sm"  onclick="search('+audit_id+')">查看</button>';
	return audit;
}

function search(audit_id){
	window.location.href="roleInfoAuditedDetailPage.jsp?audit_id="+audit_id;
}
