...
function reqGetJobHunterInfoAuditList(){
	var req = {};	
	req["op"] = "getJobHunterInfoAuditedList";
...
function displayButtons(cellValue,options,rowObject){
	...
	var audit = '<button class=" btn btn-primary btn-sm"  onclick="display('+audit_id+')">查看</button>';
	return audit;
}

function display(audit_id){
	window.location.href="jobHunterInfoAuditedDetailPage.jsp?audit_id="+audit_id;
}
