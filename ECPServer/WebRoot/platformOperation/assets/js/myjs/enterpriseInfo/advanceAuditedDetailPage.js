...
$(document).ready(function(){
	getAdvanceAuditDetail();
});

function getAdvanceAuditDetail(){
	cVe.startReqByMsgHandle(cVeName,'','','reqGetAdvanceAuditDetail','resGetAdvanceAuditDetail','ECP.handle.platform.OrgAuditHandle.handleMsg');
}

function reqGetAdvanceAuditDetail(){
/*	var userId*/
	var req = {};
	req["op"] = "getAdvanceInfoDetail";
	req["audit_id"] = audit_id;
	cVe.setConn(cServerUri,"POST", true, JSON.stringify(req));
}

function resGetAdvanceAuditDetail(){
